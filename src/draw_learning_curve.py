...
if __name__ == "__main__":
    ...
    parser.add_argument('--result_file', dest='result_file', type=str, default='./deep_dialog/old_checkpoints/rl_agent/noe2e/agt_9_performance_records.json', help='path to the result file')
