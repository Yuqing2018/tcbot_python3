...
# from deep_dialog.RealUser import RealUser
...
if __name__ == "__main__":
    ...
    # RL agent parameters
    parser.add_argument('--experience_replay_pool_size', dest='experience_replay_pool_size', type=int, default=100, help='the size for experience replay')
    ...
    #'./deep_dialog/checkpoints/rl_agent/noe2e/agt_9_478_500_0.98000.p'
    parser.add_argument('--trained_model_path', dest='trained_model_path', type=str, default='./deep_dialog/old_checkpoints/rl_agent/noe2e/agt_9_478_500_0.98000.p', help='the path for trained model')
...
def convertFile(originPath):
    ...
    with open(originPath, 'rb') as f:
        ...
        with open(destiPath, 'wb') as output:
            ...
            #     outsize += len(line) + 1
            #     output.write(line.encode() + str.encode("\n"))
    print("successfully! ")
    return destiPath
if(params['trained_model_path'] != None):
    params['trained_model_path'] = convertFile(params['trained_model_path'])
